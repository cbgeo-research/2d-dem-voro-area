...
# define NDIM 2
 ...
 r8mat_transpose_print ( NDIM, g_num, g_xy, "  The generators" );
  ...
  std::ofstream fout1;
  fout1.open("Vertices.data",ios::out);
  // fout1 << " V_NUM: Number of Voronoi vertices = " << v_num << "\n";
  //fout1 << v_num ;
  fout1.close();
...
//
{
  int i;
  std::ofstream fout3;
  fout3.open("Degree.data",ios::out);
  if ( 0 < s_len_trim ( title ) )
  {
    cout << "\n";
    cout << title << "\n";
...
# define INCX 5
  ...
  int j2lo;
  std::ofstream fout1;
  fout1.open("Vertices.data",ios::app);
...
//
  ...
  cout << "\n";
  std::ofstream fout2;
  fout2.open("Connectivity.data",ios::out);
// fout2 <<"Tesselation \t Indices"; 
  for ( j = 0; j < g_num; j++ )
  {
    k = g_start[j] - 1;
    cout << "\n";
